            ...
            category.id===races.kategoria?
              <div className="card bg-base-100 w-96 shadow-xl" key={races.id}>
                <figure className='relative'>
                  <img
                    src="https://img.daisyui.com/images/stock/photo-1606107557195-0e29a4b5b4aa.webp"  alt={races.palya} className='transition-opacity duration-300 hover:opacity-0' />
