            ...
            <dialog ref={modalRef} id="add" className="modal">
                <div className="modal-box max-h-screen p-6 rounded-2xl shadow-lg bg-emerald-600">
                    ...
                    <input
                        ...
                        id="file"
                        type="file"
                        className="file-input text-black w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                        {...register("file", {
                            validate: (value) => {
                    ...
                    <label className='block text-black font-medium mt-4'>Versenyzők száma</label>
                    <input 
                        id="maxracers" 
                        type="number" 
                        min="1" max="100"
                        className="input w-full border text-black border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                        {...register("maxracers", { 
                    ...
                    {errors.maxracers && <p className="text-red-500 text-sm mt-1">{errors.maxracers.message}</p>}
                        ...
                        <input id="date" type="date"
                            className="input w-full text-black border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
